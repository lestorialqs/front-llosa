...
const projects = [
  {
    ...
    timeline: "Jan 2024 - Dec 2025", status: "Under Construction",
    statusBg: "bg-[#c2e8ff] text-[#244b5e]", depts: 45, progress: 60,
  ...
  },
  {
    ...
    timeline: "Mar 2023 - Jun 2024", status: "Delivered",
    statusBg: "bg-[#e2e2e4] text-[#41484c]", depts: 120, progress: 100,
  ...
  },
  {
    ...
    timeline: "Sep 2024 - Aug 2026", status: "Planning",
    statusBg: "bg-[#e9e0e1] text-[#696364]", depts: 60, progress: 5,
    progressBg: "bg-[#696364]", img: null
  },
  {
    name: "Edificio Central", location: "Surco, Lima",
    timeline: "Feb 2024 - Nov 2025", status: "For Sale",
    statusBg: "bg-[#ffdcbf] text-[#623f1c]", depts: 30, progress: 40,
...
const kpis = [
  {icon:"domain",label:"Total Projects",val:24,bg:"bg-[#c2e8ff]",iconColor:"text-[#244b5e]"},
  {icon:"engineering",label:"Under Construction",val:8,bg:"bg-[#e9e0e1]",iconColor:"text-[#696364]"},
  {icon:"real_estate_agent",label:"For Sale",val:12,bg:"bg-[#ffdcbf]",iconColor:"text-[#623f1c]"},
  {icon:"check_circle",label:"Delivered",val:4,bg:"bg-[#e2e2e4]",iconColor:"text-[#41484c]"},
];
  ...
  return (
    <AdminLayout>
      <div className="flex justify-between items-end">
        <div>
          <h1 className="text-[36px] leading-[44px] font-bold tracking-[-0.02em] text-[#1a1c1d]">Project Portfolio</h1>
          <p className="text-base text-[#41484c] mt-2">Manage developments, track construction progress, and oversee timelines.</p>
        </div>
      ...
      <div className="bg-white border border-[#c1c7cc] rounded-xl overflow-hidden shadow-[0_4px_20px_rgba(2,49,67,0.02)]">
        <table className="w-full text-left border-collapse">
          <thead>
            <tr className="bg-[#f9f9fb] border-b border-[#e2e2e4]">
              {["Project","Timeline","Status","Depts","Progress","Actions"].map(h => (
                <th key={h} className={`py-4 px-6 text-[12px] font-semibold text-[#023143] uppercase tracking-wider ${h==="Actions"?"text-right w-24":h==="Project"?"w-1/3":""}`}>{h}</th>
              ))}
            </tr>
          </thead>
        ...
        <div className="px-6 py-4 border-t border-[#e2e2e4] bg-[#f9f9fb] flex justify-between items-center">
          <span className="text-sm text-[#41484c]">Showing 1 to 4 of 24 projects</span>
          <div className="flex gap-1">
            <button className="px-3 py-1 border border-[#c1c7cc] rounded bg-white text-[#72787c] hover:bg-[#e2e2e4] transition-colors disabled:opacity-50" disabled>Prev</button>
            ...
            <button className="px-3 py-1 border border-[#c1c7cc] rounded bg-white text-[#72787c] hover:bg-[#e2e2e4] transition-colors">Next</button>
          </div>
        </div>
      </div>
    </AdminLayout>
