...
const calDays = [
  ...
  {day:3,events:[]},
  {day:4,events:[{label:"Signing: Miraflores 402",bg:"bg-[#e9e0e1]",dot:"bg-[#1e1b1c]",text:"text-[#1e1b1c]"}]},
  {day:5,grey:true,events:[]},
  {day:6,grey:true,events:[]},
  {day:7,events:[{label:"Project Start: Q Tower",bg:"bg-[#ffdcbf]",dot:"bg-[#2d1600]",text:"text-[#2d1600]"}]},
  {day:8,today:true,events:[{label:"Doc Delivery - City Hall",bg:"bg-[#eeeeef]",icon:"description",text:"text-[#41484c]"},{label:"Internal Review",bg:"bg-[#c2e8ff]",dot:"bg-[#001e2b]",text:"text-[#001e2b]"}]},
  ...
  return (
    <AdminLayout>
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-[28px] leading-[36px] font-semibold text-[#1a1c1d]">Administrative Calendar</h2>
          <p className="text-sm text-[#72787c] mt-1">Manage events, project milestones, and client meetings.</p>
        </div>
      ...
      <div className="bg-white border border-[#c1c7cc] rounded-xl p-4 flex flex-wrap items-center gap-4 shadow-[0_4px_20px_rgba(2,49,67,0.02)]">
        ...
        {["All Clients","All Projects","Assigned Employee","Event Type"].map(f => (
        ...
        <button className="ml-auto text-[#023143] text-[12px] font-semibold hover:underline">Clear Filters</button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-9 bg-white border border-[#e2e2e4] rounded-xl shadow-[0_4px_20px_rgba(2,49,67,0.03)] overflow-hidden flex flex-col">
          ...
          <div className="px-6 py-4 border-b border-[#e2e2e4] flex items-center justify-between bg-[#f9f9fb]">
            <div className="flex items-center gap-4">
              <h3 className="text-[20px] font-semibold text-[#1a1c1d]">October 2024</h3>
              <div className="flex items-center gap-1 bg-[#f9f9fb] border border-[#e2e2e4] rounded-lg p-0.5">
                ...
                <button className="px-3 py-1 text-[12px] font-semibold text-[#1a1c1d] hover:bg-[#e2e2e4] rounded transition-colors">Today</button>
            ...
            <div className="flex bg-[#f9f9fb] border border-[#e2e2e4] rounded-lg p-0.5">
              <button className="px-4 py-1.5 text-[12px] font-semibold bg-white text-[#1a1c1d] shadow-sm rounded-md transition-all">Month</button>
              <button className="px-4 py-1.5 text-[12px] font-semibold text-[#72787c] hover:text-[#1a1c1d] rounded-md transition-all">Week</button>
            </div>
          </div>
        ...
        <div className="lg:col-span-3 flex flex-col gap-6">
          ...
          <div className="bg-white border border-[#e2e2e4] rounded-xl p-6 shadow-[0_4px_20px_rgba(2,49,67,0.03)]">
            <h3 className="text-[20px] font-semibold text-[#1a1c1d] mb-6">Agenda - Oct 8</h3>
            <div className="flex flex-col gap-4">
              <div className="flex gap-4">
                ...
                <div className="flex-1 bg-[#f9f9fb] border border-[#c1c7cc] rounded-lg p-3 relative overflow-hidden">
                  ...
                  <h4 className="text-[12px] font-semibold text-[#1a1c1d] mb-1">Doc Delivery - City Hall</h4>
                  <p className="text-[13px] text-[#72787c] mb-2">Permit applications for Q Tower.</p>
                  <div className="flex items-center gap-2">
                    <span className="material-symbols-outlined text-[14px] text-[#72787c]">location_on</span>
                    <span className="text-[12px] text-[#72787c]">Municipality Office</span>
                  </div>
                </div>
              </div>
              <div className="flex gap-4">
                ...
                <div className="flex-1 bg-[#c2e8ff] border border-[#a5cce3] rounded-lg p-3 relative overflow-hidden">
                  <div className="absolute left-0 top-0 bottom-0 w-1 bg-[#023143]" />
                  <h4 className="text-[12px] font-semibold text-[#001e2b] mb-1">Internal Review</h4>
                  <p className="text-[13px] text-[#001e2b]/80 mb-2">Quarterly budget alignment.</p>
            ...
            <button className="w-full mt-6 py-2 border border-[#c1c7cc] text-[#1a1c1d] text-[12px] font-semibold rounded-lg hover:bg-[#f9f9fb] transition-colors">View Full Agenda</button>
          </div>

          {/* Legend */}
          <div className="bg-white border border-[#e2e2e4] rounded-xl p-6 shadow-[0_4px_20px_rgba(2,49,67,0.03)]">
            <h3 className="text-[20px] font-semibold text-[#1a1c1d] mb-4">Event Legend</h3>
            <div className="flex flex-col gap-3">
              {[
                {bg:"bg-[#c2e8ff] border-[#a5cce3]",label:"Client Meetings"},
                {bg:"bg-[#e9e0e1] border-[#cdc4c5]",label:"Signing Dates"},
                {bg:"bg-[#ffdcbf] border-[#f0bd8f]",label:"Project Starts"},
                {bg:"bg-[#f9f9fb] border-[#c1c7cc]",label:"Deliveries & Admin"},
              ].map(l => (
